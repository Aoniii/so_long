...
/*   Updated: 2022/06/14 20:55:30 by snourry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_game	ft_free_texture(t_game game)
{
	...
	mlx_destroy_image(game.mlx, game.texture.player1);
	mlx_destroy_image(game.mlx, game.texture.player2);
	mlx_destroy_image(game.mlx, game.texture.player3);
	mlx_destroy_image(game.mlx, game.texture.font);
